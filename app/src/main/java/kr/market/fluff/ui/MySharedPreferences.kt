...
class MySharedPreferences(context: Context) {
    ...
    val PREF_KEY_MY_FACEBOOK_LOGIN = "facebook_login"
    ...
    var facebook_token : Long
        get() = prefs.getLong(PREF_KEY_MY_FACEBOOK_LOGIN,0)
        set(value) = editor.putLong(PREF_KEY_MY_FACEBOOK_LOGIN, value).apply()
