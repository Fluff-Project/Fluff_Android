...
class ReviewViewHolder(view : View) : RecyclerView.ViewHolder(view){
    ...
    fun addItems(){
        img_datas.add(ReviewImageDatas(img_review = "https://cdn.pixabay.com/photo/2015/11/26/00/14/fashion-1063100__340.jpg"))
        img_datas.add(ReviewImageDatas(img_review = "https://cdn.pixabay.com/photo/2014/05/03/00/56/summerfield-336672__340.jpg"))
        img_datas.add(ReviewImageDatas(img_review = "https://cdn.pixabay.com/photo/2015/09/03/08/04/photographer-920128__340.jpg"))
        img_datas.add(ReviewImageDatas(img_review = "https://cdn.pixabay.com/photo/2018/03/12/12/32/woman-3219507__340.jpg"))
        img_datas.add(ReviewImageDatas(img_review = "https://cdn.pixabay.com/photo/2015/05/03/14/40/woman-751236__340.jpg"))
        img_datas.add(ReviewImageDatas(img_review = "https://cdn.pixabay.com/photo/2015/01/15/12/46/model-600225__340.jpg"))
        img_datas.add(ReviewImageDatas(img_review = "https://cdn.pixabay.com/photo/2015/01/15/12/46/model-600225__340.jpg"))
        img_datas.add(ReviewImageDatas(img_review = "https://cdn.pixabay.com/photo/2015/01/15/12/46/model-600225__340.jpg"))
    }
    fun countItem(){
